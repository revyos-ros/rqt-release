...
Requires:       ros-jazzy-rqt-gui >= 0.3.0
Requires:       ros-jazzy-rqt-gui-cpp >= 0.3.0
Requires:       ros-jazzy-rqt-gui-py >= 0.3.0
...
%changelog
* Mon Jun 24 2024 Dharini Dutia <dharini@openrobotics.org> - 1.6.0-3
